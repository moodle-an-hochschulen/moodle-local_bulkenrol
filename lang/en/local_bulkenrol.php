...
$string['error_user_already_enroled'] = 'User in line {$a->row} (<em>{$a->email}</em>) already enroled into course.';
...
$string['user_enroled'] = 'User enroled';
$string['user_enroled_yes'] = 'Yes';
$string['user_enroled_already'] = 'already enroled';
